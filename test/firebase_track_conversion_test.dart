...
import 'package:firebase_track_conversion/firebase_track_conversion_platform_interface.dart';
...
void main() {
  final FirebaseTrackConversionPlatform initialPlatform = FirebaseTrackConversionPlatform.instance;

  test('$MethodChannelFirebaseTrackConversion is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelFirebaseTrackConversion>());
  });

  test('getPlatformVersion', () async {
    FirebaseTrackConversion firebaseTrackConversionPlugin = FirebaseTrackConversion();
    MockFirebaseTrackConversionPlatform fakePlatform = MockFirebaseTrackConversionPlatform();
